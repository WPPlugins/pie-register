...
Pie Register is a commercial grade, open source WordPress Registration Plugin from [Genetech Solutions](http://www.genetechsolutions.com/).
...
On top of the amazing features offered in the free version (Listed Above) , you get these additional features in the [Pro](http://pieregister.com/) version:
...
*   Email marketing using Aweber and MailChimp
*   Two-way login (SMS)
